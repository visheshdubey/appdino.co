...
export default function Home() {
  ...
  return (
    <main className="flex-col items-center justify-center">
      ...
      <Section>
        <div className="flex flex-col md:flex-row items-center p-10 w-full bg-red-200  gap-12 md:gap-36">
          ...
          <div className="flex">
            <iframe className="w-[360px] h-[203]  aspect-video" src="https://www.youtube.com/embed/qQk94CjRvIs"
      ...
      <Section>
        ...
        <div className="flex flex-col gap-20">
          <div className="flex flex-col md:flex-row w-full justify-between gap-10 md:gap-20 items-center">
            ...
            <div className="flex w-96 h-96 bg-gray-900">
              a
            </div>
